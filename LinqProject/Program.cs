...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            JoinWithLinqTest(categories, products);
        }

        private static void JoinWithLinqTest(List<Category> categories, List<Product> products)
        {
            //categories ile products listelerini joinler
        ...
        {
            //Single Line query
            //order by default olarak artandır
            //UnitPrice 'a göre artan olarak sıralar
            //ThenByDescending azalan metni z den a ya sıralar 
